...
// Package client provides functioanlity so that other uses of sansshell can provide their
...
// Run takes the given context and executes the command passed in after parsing with flags.
