...
var file_localfile_proto_rawDesc = []byte{
	...
	0x22, 0x23, 0x0a, 0x0b, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12,
	0x14, 0x0a, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05,
	0x65, 0x6e, 0x74, 0x72, 0x79, 0x22, 0x37, 0x0a, 0x09, 0x4c, 0x69, 0x73, 0x74, 0x52, 0x65, 0x70,
	0x6c, 0x79, 0x12, 0x2a, 0x0a, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x14, 0x2e, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x46, 0x69, 0x6c, 0x65, 0x2e, 0x53, 0x74,
	0x61, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x52, 0x05, 0x65, 0x6e, 0x74, 0x72, 0x79, 0x22, 0x4b,
...
var file_localfile_proto_depIdxs = []int32{
	...
	6,  // 8: LocalFile.ListReply.entry:type_name -> LocalFile.StatReply
	9,  // 9: LocalFile.SetFileAttributesRequest.attrs:type_name -> LocalFile.FileAttributes
	1,  // 10: LocalFile.LocalFile.Read:input_type -> LocalFile.ReadActionRequest
	5,  // 11: LocalFile.LocalFile.Stat:input_type -> LocalFile.StatRequest
	7,  // 12: LocalFile.LocalFile.Sum:input_type -> LocalFile.SumRequest
	11, // 13: LocalFile.LocalFile.Write:input_type -> LocalFile.WriteRequest
	12, // 14: LocalFile.LocalFile.Copy:input_type -> LocalFile.CopyRequest
	13, // 15: LocalFile.LocalFile.List:input_type -> LocalFile.ListRequest
	15, // 16: LocalFile.LocalFile.SetFileAttributes:input_type -> LocalFile.SetFileAttributesRequest
	4,  // 17: LocalFile.LocalFile.Read:output_type -> LocalFile.ReadReply
	6,  // 18: LocalFile.LocalFile.Stat:output_type -> LocalFile.StatReply
	8,  // 19: LocalFile.LocalFile.Sum:output_type -> LocalFile.SumReply
	17, // 20: LocalFile.LocalFile.Write:output_type -> google.protobuf.Empty
	17, // 21: LocalFile.LocalFile.Copy:output_type -> google.protobuf.Empty
	14, // 22: LocalFile.LocalFile.List:output_type -> LocalFile.ListReply
	17, // 23: LocalFile.LocalFile.SetFileAttributes:output_type -> google.protobuf.Empty
