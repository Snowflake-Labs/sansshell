...
// CWE-93 regression suite for SNOW-3688822: a caller authorized for a single dotenv
// key must never be able to inject additional environment variables via a
// newline (or an unsafe key), and a rejected write must not modify the file.
