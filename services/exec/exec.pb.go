...
func (x *ExecResponse) GetError() []byte {
	if x != nil {
		return x.Error
	}
	return nil
...
var file_exec_proto_rawDesc = []byte{
	...
	0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x22, 0x3c, 0x0a, 0x0c, 0x45, 0x78, 0x65, 0x63, 0x52, 0x65, 0x73,
	...
	0x72, 0x6f, 0x72, 0x32, 0x2d, 0x0a, 0x04, 0x45, 0x78, 0x65, 0x63, 0x12, 0x25, 0x0a, 0x04, 0x45,
	...
	0x22, 0x00, 0x42, 0x08, 0x5a, 0x06, 0x2e, 0x2f, 0x65, 0x78, 0x65, 0x63, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_exec_proto_depIdxs = []int32{
	0, // 0: Exec.Exec:input_type -> ExecRequest
	1, // 1: Exec.Exec:output_type -> ExecResponse
