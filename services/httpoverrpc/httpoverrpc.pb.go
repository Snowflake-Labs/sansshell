...
type LocalhostHTTPRequest struct {
...
var file_httpoverrpc_proto_rawDesc = []byte{
	...
	0x22, 0x5e, 0x0a, 0x14, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x68, 0x6f, 0x73, 0x74, 0x48, 0x54, 0x54,
	0x50, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x32, 0x0a, 0x07, 0x72, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x48, 0x54, 0x54, 0x50,
	0x4f, 0x76, 0x65, 0x72, 0x52, 0x50, 0x43, 0x2e, 0x48, 0x54, 0x54, 0x50, 0x52, 0x65, 0x71, 0x75,
	...
	0x22, 0x32, 0x0a, 0x06, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65,
	...
	0x6c, 0x75, 0x65, 0x73, 0x22, 0x89, 0x01, 0x0a, 0x0b, 0x48, 0x54, 0x54, 0x50, 0x52, 0x65, 0x71,
	...
	0x79, 0x32, 0x57, 0x0a, 0x0b, 0x48, 0x54, 0x54, 0x50, 0x4f, 0x76, 0x65, 0x72, 0x52, 0x50, 0x43,
	0x12, 0x48, 0x0a, 0x09, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x68, 0x6f, 0x73, 0x74, 0x12, 0x21, 0x2e,
	0x48, 0x54, 0x54, 0x50, 0x4f, 0x76, 0x65, 0x72, 0x52, 0x50, 0x43, 0x2e, 0x4c, 0x6f, 0x63, 0x61,
	0x6c, 0x68, 0x6f, 0x73, 0x74, 0x48, 0x54, 0x54, 0x50, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x16, 0x2e, 0x48, 0x54, 0x54, 0x50, 0x4f, 0x76, 0x65, 0x72, 0x52, 0x50, 0x43, 0x2e, 0x48,
	0x54, 0x54, 0x50, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x22, 0x00, 0x42, 0x31, 0x5a, 0x2f, 0x67, 0x69,
	...
	0x6c, 0x2f, 0x68, 0x74, 0x74, 0x70, 0x6f, 0x76, 0x65, 0x72, 0x72, 0x70, 0x63, 0x62, 0x06, 0x70,
...
var file_httpoverrpc_proto_goTypes = []interface{}{
	(*LocalhostHTTPRequest)(nil), // 0: HTTPOverRPC.LocalhostHTTPRequest
...
var file_httpoverrpc_proto_depIdxs = []int32{
	2, // 0: HTTPOverRPC.LocalhostHTTPRequest.request:type_name -> HTTPOverRPC.HTTPRequest
	...
	0, // 3: HTTPOverRPC.HTTPOverRPC.Localhost:input_type -> HTTPOverRPC.LocalhostHTTPRequest
	3, // 4: HTTPOverRPC.HTTPOverRPC.Localhost:output_type -> HTTPOverRPC.HTTPReply
...
func file_httpoverrpc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_httpoverrpc_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LocalhostHTTPRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
