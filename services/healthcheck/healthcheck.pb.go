...
// Empty is used as both the request and response message
type Empty struct {
...
var file_healthcheck_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b,
	0x22, 0x07, 0x0a, 0x05, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x32, 0x3d, 0x0a, 0x0b, 0x48, 0x65, 0x61,
	0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x12, 0x2e, 0x0a, 0x02, 0x4f, 0x6b, 0x12, 0x12,
	0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x2e, 0x45, 0x6d, 0x70,
	0x74, 0x79, 0x1a, 0x12, 0x2e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x43, 0x68, 0x65, 0x63, 0x6b,
	...
	0x76, 0x69, 0x63, 0x65, 0x73, 0x2f, 0x68, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x63, 0x68, 0x65, 0x63,
...
var file_healthcheck_proto_goTypes = []interface{}{
	(*Empty)(nil), // 0: HealthCheck.Empty
}
var file_healthcheck_proto_depIdxs = []int32{
	0, // 0: HealthCheck.HealthCheck.Ok:input_type -> HealthCheck.Empty
	0, // 1: HealthCheck.HealthCheck.Ok:output_type -> HealthCheck.Empty
