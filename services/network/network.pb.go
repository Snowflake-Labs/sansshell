...
const (
	...
	TCPCheckFailureReason_SOURCE_PORT_IN_USE TCPCheckFailureReason = 4
	TCPCheckFailureReason_PERMISSION_DENIED  TCPCheckFailureReason = 5
)
...
type TCPCheckRequest struct {
	...
	// Source port to bind for the outgoing connection. If 0, the OS
	// chooses an ephemeral port (LocalAddr is left unset).
...
func (x *TCPCheckRequest) GetSourcePort() uint32 {
	if x != nil {
		return x.SourcePort
	}
	return 0
...
const file_network_proto_rawDesc = "" +
	"\n" +
	"\rnetwork.proto\x12\aNetwork\x1a\x1egoogle/protobuf/duration.proto\"\x97\x01\n" +
	...
	"\f_fail_reason*\x8a\x01\n" +
	"\x15TCPCheckFailureReason\x12\v\n" +
	"\aUNKNOWN\x10\x00\x12\v\n" +
	"\aTIMEOUT\x10\x01\x12\x16\n" +
	"\x12CONNECTION_REFUSED\x10\x02\x12\x10\n" +
	"\fNO_SUCH_HOST\x10\x03\x12\x16\n" +
	"\x12SOURCE_PORT_IN_USE\x10\x04\x12\x15\n" +
	"\x11PERMISSION_DENIED\x10\x052I\n" +
	"\aNetwork\x12>\n" +
