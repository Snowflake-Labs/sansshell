...
type Action struct {
	...
	// Optional extension payload (included in the action hash).
	CustomPayload *anypb.Any `protobuf:"bytes,5,opt,name=custom_payload,json=customPayload,proto3" json:"custom_payload,omitempty"`
...
func (x *Action) GetCustomPayload() *anypb.Any {
	if x != nil {
...
type StoreRequest struct {
	...
	// Optional closed-source extension payload stored with the action.
	CustomPayload *anypb.Any `protobuf:"bytes,3,opt,name=custom_payload,json=customPayload,proto3" json:"custom_payload,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *StoreRequest) GetCustomPayload() *anypb.Any {
	if x != nil {
		return x.CustomPayload
	}
	return nil
...
const file_mpa_proto_rawDesc = "" +
	"\n" +
	"\tmpa.proto\x12\x03Mpa\x1a\x19google/protobuf/any.proto\"\xc7\x01\n" +
	"\x06Action\x12\x12\n" +
	...
	"\x0ecustom_payload\x18\x05 \x01(\v2\x14.google.protobuf.AnyR\rcustomPayload\"3\n" +
	"\tPrincipal\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x16\n" +
	"\x06groups\x18\x02 \x03(\tR\x06groups\"\x93\x01\n" +
	"\fStoreRequest\x12\x16\n" +
	"\x06method\x18\x01 \x01(\tR\x06method\x12.\n" +
	"\amessage\x18\x02 \x01(\v2\x14.google.protobuf.AnyR\amessage\x12;\n" +
	"\x0ecustom_payload\x18\x03 \x01(\v2\x14.google.protobuf.AnyR\rcustomPayload\"p\n" +
...
var file_mpa_proto_depIdxs = []int32{
	...
	15, // 1: Mpa.Action.custom_payload:type_name -> google.protobuf.Any
	15, // 2: Mpa.StoreRequest.message:type_name -> google.protobuf.Any
	15, // 3: Mpa.StoreRequest.custom_payload:type_name -> google.protobuf.Any
	0,  // 4: Mpa.StoreResponse.action:type_name -> Mpa.Action
	1,  // 5: Mpa.StoreResponse.approver:type_name -> Mpa.Principal
	0,  // 6: Mpa.ApproveRequest.action:type_name -> Mpa.Action
	14, // 7: Mpa.ListResponse.item:type_name -> Mpa.ListResponse.Item
	0,  // 8: Mpa.GetResponse.action:type_name -> Mpa.Action
	1,  // 9: Mpa.GetResponse.approver:type_name -> Mpa.Principal
	0,  // 10: Mpa.ClearRequest.action:type_name -> Mpa.Action
	0,  // 11: Mpa.ListResponse.Item.action:type_name -> Mpa.Action
	1,  // 12: Mpa.ListResponse.Item.approver:type_name -> Mpa.Principal
	2,  // 13: Mpa.Mpa.Store:input_type -> Mpa.StoreRequest
	4,  // 14: Mpa.Mpa.Approve:input_type -> Mpa.ApproveRequest
	6,  // 15: Mpa.Mpa.WaitForApproval:input_type -> Mpa.WaitForApprovalRequest
	8,  // 16: Mpa.Mpa.List:input_type -> Mpa.ListRequest
	10, // 17: Mpa.Mpa.Get:input_type -> Mpa.GetRequest
	12, // 18: Mpa.Mpa.Clear:input_type -> Mpa.ClearRequest
	3,  // 19: Mpa.Mpa.Store:output_type -> Mpa.StoreResponse
	5,  // 20: Mpa.Mpa.Approve:output_type -> Mpa.ApproveResponse
	7,  // 21: Mpa.Mpa.WaitForApproval:output_type -> Mpa.WaitForApprovalResponse
	9,  // 22: Mpa.Mpa.List:output_type -> Mpa.ListResponse
	11, // 23: Mpa.Mpa.Get:output_type -> Mpa.GetResponse
	13, // 24: Mpa.Mpa.Clear:output_type -> Mpa.ClearResponse
