...
type ProcessEntry struct {
	...
	Stat            string        `protobuf:"bytes,21,opt,name=stat,proto3" json:"stat,omitempty"`
	Flags           *ProcessFlags `protobuf:"bytes,22,opt,name=flags,proto3" json:"flags,omitempty"`
	State           ProcessState  `protobuf:"varint,23,opt,name=state,proto3,enum=Process.ProcessState" json:"state,omitempty"`
...
func (x *ProcessEntry) GetStat() string {
	if x != nil {
		return x.Stat
	}
	return ""
...
var file_process_proto_rawDesc = []byte{
	...
	0x52, 0x6f, 0x6f, 0x74, 0x50, 0x72, 0x69, 0x76, 0x73, 0x22, 0xd3, 0x06, 0x0a, 0x0c, 0x50, 0x72,
	...
	,
...
var file_process_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_process_proto_goTypes = []interface{}{
	...
	(BlobDestination)(0),           // 1: Process.BlobDestination
	(*ListRequest)(nil),            // 2: Process.ListRequest
	(*ProcessFlags)(nil),           // 3: Process.ProcessFlags
	(*ProcessEntry)(nil),           // 4: Process.ProcessEntry
	(*ListReply)(nil),              // 5: Process.ListReply
	(*GetStacksRequest)(nil),       // 6: Process.GetStacksRequest
	(*ThreadStack)(nil),            // 7: Process.ThreadStack
	(*GetStacksReply)(nil),         // 8: Process.GetStacksReply
	(*GetJavaStacksRequest)(nil),   // 9: Process.GetJavaStacksRequest
	(*JavaThreadStack)(nil),        // 10: Process.JavaThreadStack
	(*GetJavaStacksReply)(nil),     // 11: Process.GetJavaStacksReply
	(*GetCoreRequest)(nil),         // 12: Process.GetCoreRequest
	(*GetCoreReply)(nil),           // 13: Process.GetCoreReply
	(*GetJavaHeapDumpRequest)(nil), // 14: Process.GetJavaHeapDumpRequest
	(*GetJavaHeapDumpReply)(nil),   // 15: Process.GetJavaHeapDumpReply
}
var file_process_proto_depIdxs = []int32{
	3,  // 0: Process.ProcessEntry.flags:type_name -> Process.ProcessFlags
	0,  // 1: Process.ProcessEntry.state:type_name -> Process.ProcessState
	4,  // 2: Process.ListReply.process_entries:type_name -> Process.ProcessEntry
	7,  // 3: Process.GetStacksReply.stacks:type_name -> Process.ThreadStack
	10, // 4: Process.GetJavaStacksReply.stacks:type_name -> Process.JavaThreadStack
	1,  // 5: Process.GetCoreRequest.destination:type_name -> Process.BlobDestination
	1,  // 6: Process.GetJavaHeapDumpRequest.destination:type_name -> Process.BlobDestination
	2,  // 7: Process.Process.List:input_type -> Process.ListRequest
	6,  // 8: Process.Process.GetStacks:input_type -> Process.GetStacksRequest
	9,  // 9: Process.Process.GetJavaStacks:input_type -> Process.GetJavaStacksRequest
	12, // 10: Process.Process.GetCore:input_type -> Process.GetCoreRequest
	14, // 11: Process.Process.GetJavaHeapDump:input_type -> Process.GetJavaHeapDumpRequest
	5,  // 12: Process.Process.List:output_type -> Process.ListReply
	8,  // 13: Process.Process.GetStacks:output_type -> Process.GetStacksReply
	11, // 14: Process.Process.GetJavaStacks:output_type -> Process.GetJavaStacksReply
	13, // 15: Process.Process.GetCore:output_type -> Process.GetCoreReply
	15, // 16: Process.Process.GetJavaHeapDump:output_type -> Process.GetJavaHeapDumpReply
