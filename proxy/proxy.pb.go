...
func (x *ProxyRequest) GetStartStream() *StartStream {
	if x != nil {
		if x, ok := x.Request.(*ProxyRequest_StartStream); ok {
...
func (x *ProxyRequest) GetStreamData() *StreamData {
	if x != nil {
		if x, ok := x.Request.(*ProxyRequest_StreamData); ok {
			return x.StreamData
		}
	}
	return nil
...
func (x *ProxyRequest) GetClientClose() *ClientClose {
	if x != nil {
		if x, ok := x.Request.(*ProxyRequest_ClientClose); ok {
...
func (x *ProxyRequest) GetClientCancel() *ClientCancel {
	if x != nil {
		if x, ok := x.Request.(*ProxyRequest_ClientCancel); ok {
...
func (x *ProxyReply) GetReply() isProxyReply_Reply {
	if x != nil {
		return x.Reply
	}
	return nil
...
func (x *ProxyReply) GetStartStreamReply() *StartStreamReply {
	if x != nil {
		if x, ok := x.Reply.(*ProxyReply_StartStreamReply); ok {
...
func (x *ProxyReply) GetStreamData() *StreamData {
	if x != nil {
		if x, ok := x.Reply.(*ProxyReply_StreamData); ok {
			return x.StreamData
		}
	}
	return nil
...
func (x *ProxyReply) GetServerClose() *ServerClose {
	if x != nil {
		if x, ok := x.Reply.(*ProxyReply_ServerClose); ok {
...
func (x *StartStreamReply) GetReply() isStartStreamReply_Reply {
	if x != nil {
		return x.Reply
	}
	return nil
...
func (x *StartStreamReply) GetStreamId() uint64 {
	if x != nil {
		if x, ok := x.Reply.(*StartStreamReply_StreamId); ok {
			return x.StreamId
		}
	}
	return 0
...
func (x *StartStreamReply) GetErrorStatus() *Status {
	if x != nil {
		if x, ok := x.Reply.(*StartStreamReply_ErrorStatus); ok {
...
const file_proxy_proto_rawDesc = "" +
	...
	"\x05Proxy\x125\n" +
	"\x05Proxy\x12\x13.Proxy.ProxyRequest\x1a\x11.Proxy.ProxyReply\"\x00(\x010\x01B+Z)github.com/Snowflake-Labs/sansshell/proxyb\x06proto3"
