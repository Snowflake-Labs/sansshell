...
const (
	TestService_TestUnary_FullMethodName        = "/Testdata.TestService/TestUnary"
	TestService_TestServerStream_FullMethodName = "/Testdata.TestService/TestServerStream"
	TestService_TestClientStream_FullMethodName = "/Testdata.TestService/TestClientStream"
	TestService_TestBidiStream_FullMethodName   = "/Testdata.TestService/TestBidiStream"
)
...
func (c *testServiceClient) TestUnary(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (*TestResponse, error) {
	...
	err := c.cc.Invoke(ctx, TestService_TestUnary_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *testServiceClient) TestServerStream(ctx context.Context, in *TestRequest, opts ...grpc.CallOption) (TestService_TestServerStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &TestService_ServiceDesc.Streams[0], TestService_TestServerStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *testServiceClient) TestClientStream(ctx context.Context, opts ...grpc.CallOption) (TestService_TestClientStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &TestService_ServiceDesc.Streams[1], TestService_TestClientStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *testServiceClient) TestBidiStream(ctx context.Context, opts ...grpc.CallOption) (TestService_TestBidiStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &TestService_ServiceDesc.Streams[2], TestService_TestBidiStream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
